...
# A RAG BASED SYSTEM 🐋
### Built on parent - child architecture 
### Built by PRIYUM DEB 
## Overview
...
as the current version it can handle more than 10 diffrent types pdf at once.
## FEATURES
...
##  File Structure and its work

The pipeline is modular, split into three distinct scripts that handle data step-by-step in 3 distinct files:
